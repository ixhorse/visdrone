from dataloaders.datasets import cityscapes, coco, combine_dbs, pascal, sbd, tt100k, visdrone, hkb
...
def make_data_loader(args, **kwargs):
    ...
    if args.dataset == 'pascal':
        ...
        train_set = hkb.HKBSegmentation(args, split='train')
        val_set = hkb.HKBSegmentation(args, split='val')
